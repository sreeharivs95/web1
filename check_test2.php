                    ...
                    <section class="main-content " style=" background-color: white;">
                            ...
                            <div style=" width: 100%; height: 737px;;">
                                ...
                                <div style=" width:100%; height:534px; background-color: whitesmoke;  margin: 25px 0px 0px 0px; float: left;" >
                                    ...
                                    <div id="main_main" style="width:100%; height: auto; background-color: white;">
                                        ...
                                        <div style="width:70%; height: 400px;  float: left;">
                                            <div style="width:100%; height: 100px; ">
                                                ...
                                                <div style="width:70%; height: 100px; background-color:black; color: white; border-bottom: 1px solid white; float: left;"><label style="text-align: center; margin-top:35px;font-size: 20px;">When an ambulance is approaching</label></div>
                                                
                                                <div style="width:100%; height: 300px;  float: left;">

                                                    <button onclick="one_one()" style="width:80%; height: 40px;color: white; background-color: rgb(240,104,34);  margin: 6% 0% 0% 10%; text-align: center; ">The driver shall allow free passage by drawing to the side of the road</button>
                                                    <button onclick="one_two()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">No preference need be given</button>
                                                    <button onclick="one_three()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Allow passage if there is no vehicles from front side</button>
                                        ...
                                        <div style="width:70%; height: 400px;  float: left;">
                                            <div style="width:100%; height: 100px; ">
                                                <div style="width:30%; height: 100px; background-color: black; color: white; float: left;  font-family: Times New Roman;"><label style="margin:15% 0% 0% 20%;font-size: 20px;">Question No.2</label></div>
                                                <div style="width:70%; height: 100px; background-color: black; color: white; float: left;"><label style="text-align: center; margin-top:35px;font-size: 20px;">Signs represents</label></div>
                                                
                                                <div style="width:100%; height: 300px;  float: left;">

                                                    <button onclick="two_one()" style="width:80%; height: 40px;color: white; background-color: rgb(240,104,34);  margin: 6% 0% 0% 10%; text-align: center; ">Narrow bridge ahead</button>
                                                    <button onclick="two_two()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Narrow road ahead</button>
                                                    <button onclick="two_three()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Entry in both direction</button>
                                                    <input type="hidden" id="two_one"  value="0">
                                                    <input type="hidden" id="two_two"  value="1">
                                                    <input type="hidden" id="two_three"  value="0">
                                                </div>
                                        ...
                                        <div style="width:30%; height: 400px; float: left;">
                                            ...
                                            <div style="width:100%; height: 50px; background-color: black; margin-top: 0px; color: white;">
                                            ...
                                            <div style=" width: 90%;  margin: 15% 0% 0% 0%; height: 174px; background-color: black; float: left;">
                                                <img src="admin/images/a3.png" style="  width: 100px; height: 100px; margin: 5% 0% 0% 20%;">
                                            </div>
                                        </div>
                                         </div>
                                        ...
                                        <div style="width:70%; height: 400px;  float: left;">
                                            <div style="width:100%; height: 100px; ">
                                                ...
                                                <div style="width:70%; height: 100px; background-color: black; color: white; border-bottom: 1px solid white; float: left;"><label style="text-align: center; margin-top:35px;font-size: 20px;">Use of horn prohibited</label></div>
                                                
                                                <div style="width:100%; height: 300px;  float: left;">

                                                    <button onclick="three_one()" style="width:80%; height: 40px;color: white; background-color: rgb(240,104,34); margin: 6% 0% 0% 10%; text-align: center; ">Mosque church and Temple</button>
                                                    <button onclick="three_two()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Near Police Station</button>
                                                    <button onclick="three_three()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Near Hospital, Courts of Law</button>
                                        ...
                                        <div style="width:70%; height: 400px;  float: left;">
                                            <div style="width:100%; height: 100px; ">
                                                <div style="width:30%; height: 100px; background-color: black; color: white; float: left;  font-family: Times New Roman;"><label style="margin:15% 0% 0% 20%;font-size: 20px;">Question No.7</label></div>
                                                <div style="width:70%; height: 100px; background-color: black; color: white; float: left;"><label style="text-align: center; margin-top:35px;font-size: 20px;">Signs represents</label></div>
                                                
                                                <div style="width:100%; height: 300px;  float: left;">

                                                    <button onclick="seven_one()" style="width:80%; height: 40px;color: white; background-color: rgb(240,104,34);  margin: 6% 0% 0% 10%; text-align: center; ">Overtaking prohibited</button>
                                                    <button onclick="seven_two()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">No entry</button>
                                                    <button onclick="seven_three()" style="width:80%; height: 40px; color: white; background-color: rgb(240,104,34);  margin: 4% 0% 0% 10%; text-align: center; ">Entry in both direction</button>
                                        ...
                                        <div style="width:30%; height: 400px; float: left;">
                                            ...
                                            <div style=" width: 90%;  margin: 15% 0% 0% 0%; height: 174px; background-color: black; float: left;">
                                                <img src="admin/images/a2.png" style="  width: 100px; height: 100px; margin: 5% 0% 0% 20%;">
                                            </div>
                                        </div>
                                         </div>
                                        <!-- 8 -->
                                    ...
                                    <label id="thank" style=" margin-top: 100px;display: none; font-family: Times New Roman; font-size:35px; text-align: center; color:lightgreen;">  <p class="blink1">Congratulations You Win Thank You!.....</p></label>
                                    <label id="sorry" style=" margin-top: 100px;display: none; font-family: Times New Roman; font-size:35px; text-align: center; color: rgb(240,104,34);">  <p class="blink1">Sorry Study Well    Thank You!.....</p></label>
                                    <a href="check_test.php"> <img src="themes/images/user/try.png" id="try" style="display: none;  margin: 8% 0% 0% 42%;"></a>
